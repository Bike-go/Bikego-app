...
__all__ = [
    'bike_bp', 'category_bp', 'inspection_bp', 'maintenance_bp', 'news_bp', 'payment_bp', 'picture_bp', 'price_bp', 'rental_bp', 'repair_bp', 'reservation_bp', 'review_bp', 'statistics_bp', 'user_bp'
]